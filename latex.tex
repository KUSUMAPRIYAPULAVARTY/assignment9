...
\end{align}
Consider $i^{th}$ equation in $\eqref{1}$ and $j^{th}$ equation in $\eqref{2}$ 
\begin{align}
    \myvec{A_{i1}&A_{i2}}\myvec{x_1\\x_2}=0\\
    \myvec{B_{j1}&B_{j2}}\myvec{x_1\\x_2}=0
\end{align}
Since they have the same solution, we can deduce
\begin{align}
     \myvec{A_{i1}&A_{i2}}=k \myvec{B_{j1}&B_{j2}}
\end{align}
where k is a scalar.\\
This is true for all the equations in $\eqref{1}$ and $\eqref{2}$ proving that they are equivalent.
\end{document}
